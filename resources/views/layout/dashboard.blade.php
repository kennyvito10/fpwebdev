		...
		<div class="menu_container menu_mm">
			<div class="page_menu_content">
				...
				<ul class="page_menu_nav menu_mm">
					...
					<li class="page_menu_item menu_mm"><a href="{{ url('/aboutusignedin') }}">About Us<i class="fa fa-angle-down"></i></a></li>
					<li class="page_menu_item menu_mm"><a href="{{ url('/profile') }}">Profile<i class="fa fa-angle-down"></i></a></li>
					<li class="page_menu_item menu_mm"><a href="{{ url('/logout') }}">Log Out<i class="fa fa-angle-down"></i></a></li>
				</ul>
			</div>
		</div>
